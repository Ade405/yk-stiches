                        ...
                        <form onSubmit={handleAdminLoginSubmit} className="space-y-3 text-xs">
                          ...
                          <div>
                            ...
                            <div className="relative">
                              ...
                              />
                              <button type="button" onClick={() => setShowAdminPassword((visible) => !visible)} className="absolute right-2 top-1/2 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-lg bg-white text-zinc-600 hover:bg-zinc-100 hover:text-black" aria-label={showAdminPassword ? 'Hide password' : 'Show password'}>
                          ...
                          <div>
                            ...
                            <div className="relative">
                              ...
                              <input
                                ...
                                className="w-full bg-zinc-50 border border-zinc-300 rounded-xl pl-9 pr-10 py-2.5 text-xs text-black focus:outline-none focus:border-black font-mono"
                              />
                              <button type="button" onClick={() => setShowTailorPassword((visible) => !visible)} className="absolute right-2 top-1/2 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-lg bg-white text-zinc-600 hover:bg-zinc-100 hover:text-black" aria-label={showTailorPassword ? 'Hide password' : 'Show password'}>
